...
Route::prefix('v1')->group(function () {
    ...
    // Public external API proxies (no auth)
    Route::get('/external/random-user', [ExternalApiController::class, 'randomUser']);
    Route::get('/external/covid-stats', [ExternalApiController::class, 'covidStats']);
});
